    case (address)
        ...
        19: q_reg <= 1'b0; //  -- N counter: High Count = 3 (8 bit(s))
        20: q_reg <= 1'b0; // 
        21: q_reg <= 1'b0; // 
        22: q_reg <= 1'b0; // 
        23: q_reg <= 1'b0; // 
        ...
        28: q_reg <= 1'b0; //  -- N counter: Low Count = 2 (8 bit(s))
        29: q_reg <= 1'b0; // 
        30: q_reg <= 1'b0; // 
        31: q_reg <= 1'b0; // 
        32: q_reg <= 1'b0; // 
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 57 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b1; // 
        40: q_reg <= 1'b1; // 
        41: q_reg <= 1'b1; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 57 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b1; // 
        49: q_reg <= 1'b1; // 
        50: q_reg <= 1'b1; // 
