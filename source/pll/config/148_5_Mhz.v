    case (address)
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 11 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b0; // 
        40: q_reg <= 1'b0; // 
        41: q_reg <= 1'b1; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 11 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b0; // 
        49: q_reg <= 1'b0; // 
        50: q_reg <= 1'b1; // 
        ...
        55: q_reg <= 1'b0; //  -- clk0 counter: High Count = 4 (8 bit(s))
        56: q_reg <= 1'b0; // 
        57: q_reg <= 1'b0; // 
        58: q_reg <= 1'b0; // 
        59: q_reg <= 1'b0; // 
        ...
        64: q_reg <= 1'b0; //  -- clk0 counter: Low Count = 4 (8 bit(s))
        65: q_reg <= 1'b0; // 
        66: q_reg <= 1'b0; // 
        67: q_reg <= 1'b0; // 
        68: q_reg <= 1'b0; // 
        ...
        73: q_reg <= 1'b0; //  -- clk1 counter: High Count = 2 (8 bit(s))
        74: q_reg <= 1'b0; // 
        75: q_reg <= 1'b0; // 
        76: q_reg <= 1'b0; // 
        77: q_reg <= 1'b0; // 
        ...
        82: q_reg <= 1'b0; //  -- clk1 counter: Low Count = 2 (8 bit(s))
        83: q_reg <= 1'b0; // 
        84: q_reg <= 1'b0; // 
        85: q_reg <= 1'b0; // 
        86: q_reg <= 1'b0; // 
