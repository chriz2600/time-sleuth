    case (address)
        ...
        3: q_reg <= 1'b0; // 
        4: q_reg <= 1'b1; //  -- Loop Filter Resistance = 27 (5 bit(s)) (Setting 27)
        5: q_reg <= 1'b1; // 
        6: q_reg <= 1'b0; // 
        7: q_reg <= 1'b1; // 
        8: q_reg <= 1'b1; // 
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 7 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b0; // 
        40: q_reg <= 1'b0; // 
        41: q_reg <= 1'b0; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 7 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b0; // 
        49: q_reg <= 1'b0; // 
        50: q_reg <= 1'b0; // 
        ...
        55: q_reg <= 1'b0; //  -- clk0 counter: High Count = 8 (8 bit(s))
        56: q_reg <= 1'b0; // 
        57: q_reg <= 1'b0; // 
        58: q_reg <= 1'b0; // 
        59: q_reg <= 1'b1; // 
        ...
        64: q_reg <= 1'b0; //  -- clk0 counter: Low Count = 7 (8 bit(s))
        65: q_reg <= 1'b0; // 
        66: q_reg <= 1'b0; // 
        67: q_reg <= 1'b0; // 
        68: q_reg <= 1'b0; // 
