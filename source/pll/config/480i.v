    case (address)
        ...
        3: q_reg <= 1'b0; // 
        4: q_reg <= 1'b1; //  -- Loop Filter Resistance = 24 (5 bit(s)) (Setting 24)
        5: q_reg <= 1'b1; // 
        6: q_reg <= 1'b0; // 
        7: q_reg <= 1'b0; // 
        8: q_reg <= 1'b0; // 
        ...
        16: q_reg <= 1'b0; // 
        17: q_reg <= 1'b1; // 
        18: q_reg <= 1'b1; //  -- N counter: Bypass = 1 (1 bit(s))
        19: q_reg <= 1'b0; //  -- N counter: High Count = 0 (8 bit(s))
        20: q_reg <= 1'b0; // 
        21: q_reg <= 1'b0; // 
        22: q_reg <= 1'b0; // 
        23: q_reg <= 1'b0; // 
        ...
        25: q_reg <= 1'b0; // 
        26: q_reg <= 1'b0; // 
        27: q_reg <= 1'b0; //  -- N counter: Odd Division = 0 (1 bit(s))
        28: q_reg <= 1'b0; //  -- N counter: Low Count = 0 (8 bit(s))
        29: q_reg <= 1'b0; // 
        30: q_reg <= 1'b0; // 
        31: q_reg <= 1'b0; // 
        32: q_reg <= 1'b0; // 
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 12 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b0; // 
        40: q_reg <= 1'b0; // 
        41: q_reg <= 1'b1; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 12 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b0; // 
        49: q_reg <= 1'b0; // 
        50: q_reg <= 1'b1; // 
        ...
        55: q_reg <= 1'b0; //  -- clk0 counter: High Count = 12 (8 bit(s))
        56: q_reg <= 1'b0; // 
        57: q_reg <= 1'b0; // 
        58: q_reg <= 1'b0; // 
        59: q_reg <= 1'b1; // 
        ...
        61: q_reg <= 1'b0; // 
        62: q_reg <= 1'b0; // 
        63: q_reg <= 1'b0; //  -- clk0 counter: Odd Division = 0 (1 bit(s))
        64: q_reg <= 1'b0; //  -- clk0 counter: Low Count = 12 (8 bit(s))
        65: q_reg <= 1'b0; // 
        66: q_reg <= 1'b0; // 
        67: q_reg <= 1'b0; // 
        68: q_reg <= 1'b1; // 
        ...
        73: q_reg <= 1'b0; //  -- clk1 counter: High Count = 12 (8 bit(s))
        74: q_reg <= 1'b0; // 
        75: q_reg <= 1'b0; // 
        76: q_reg <= 1'b0; // 
        77: q_reg <= 1'b1; // 
        ...
        82: q_reg <= 1'b0; //  -- clk1 counter: Low Count = 12 (8 bit(s))
        83: q_reg <= 1'b0; // 
        84: q_reg <= 1'b0; // 
        85: q_reg <= 1'b0; // 
        86: q_reg <= 1'b1; // 
