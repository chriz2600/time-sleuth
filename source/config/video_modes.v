...
const VideoMode VIDEO_MODE_240P = {
    `MODE_240p, // id
    12'd_1716,  // h_total
    12'd_1440,  // h_active
    12'd_38,    // h_front_porch
...
const VideoMode VIDEO_MODE_960P = {
    `MODE_960p, // id
    12'd_900,  // h_total
    12'd_640,   // h_active
...
const VideoMode VIDEO_MODE_576P = {
    `MODE_576p, // id
    12'd_864,   // h_total
    12'd_720,   // h_active
...
const VideoMode VIDEO_MODE_576I = {
    `MODE_576i, // id
    12'd_1728,  // h_total
    12'd_1440,  // h_active
...
const VideoMode VIDEO_MODE_288P = {
    `MODE_288p, // id
    12'd_1728,  // h_total
    12'd_1440,  // h_active
    12'd_24,    // h_front_porch
